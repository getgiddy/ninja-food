<template>
    <div class="text-gray-600 font-body grid md:grid-cols-4"> <!-- content wrapper -->
        <div class="md:col-span-1 md:flex md:justify-end">
            <nav class="text-right">
                ...
                <ul :class="showMenu ? 'block' : 'hidden'" class="text-sm mt-6 md:block">
                    <li class="text-gray-700 font-bold py-1">
                        <NuxtLink to="#" class="px-4 flex justify-end border-r-4 border-primary">
                            <span>Home</span>
                            <svg class="w-5 ml-2" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="py-1">
                        <NuxtLink to="#" class="px-4 flex justify-end border-r-4 border-white">
                            <span>About</span>
                            <svg class="w-5 ml-2" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <main class="px-16 py-6 bg-gray-100 md:col-span-3">
            ...
            <div>
                ...
                <div class="mt-8 grid md:grid-cols-3 gap-10">
                    <!-- cards go here -->
                    <div class="card">
                        <img src="/assets/img/curry.jpg" alt="curry" class="w-full h-32 sm:h-48 object-cover">
                        <div class="m-4">
                            <span class="font-bold">Tofu Curry</span>
                            <span class="block text-gray-500 text-sm">Recipe by Mario</span>
                        </div>
                        <div class="badge">
                            <svg class="w-4 inline-block" data-slot="icon" fill="none" stroke-width="1.5"
                    ...
                    <div class="card">
                        <img src="/assets/img/noodles.jpg" alt="noodles" class="w-full h-32 sm:h-48 object-cover">
                        <div class="m-4">
                    ...
                    <div class="card">
                        <img src="/assets/img/stew.jpg" alt="stew" class="w-full h-32 sm:h-48 object-cover">
                        <div class="m-4">
